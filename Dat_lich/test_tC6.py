...
class TestTC6():
  ...
  def test_tC6(self):
    ...
    time.sleep(3)
    # Chọn khung giờ
    self.driver.find_element(By.XPATH, "//button[contains(.,'9:30')]").click()
    time.sleep(3)
    # Điền thông tin
    ...
    self.driver.find_element(By.CSS_SELECTOR, "input[id*='email']").send_keys("tmy131313@gmail")
    ...
    self.driver.find_element(By.CSS_SELECTOR, "textarea[id*='notes']").send_keys("perfect 666")
