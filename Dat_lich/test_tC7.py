...
class TestTC7():
  ...
  def test_tC7(self):
    ...
    # Chọn ngày
    self.driver.find_element(By.XPATH, "//div[@role='button' and .//span[text()='24']]").click()
    # Dropdown dịch vụ
    ...
    time.sleep(3)
    # Chọn khung giờ
    self.driver.find_element(By.XPATH, "//button[contains(.,'13:45')]").click()
    time.sleep(3)
    # Điền thông tin
    self.driver.find_element(By.CSS_SELECTOR, "input[id*='full-name']").clear()
    self.driver.find_element(By.CSS_SELECTOR, "input[id*='full-name']").send_keys("hoanmy")
    self.driver.find_element(By.CSS_SELECTOR, "input[id*='email']").clear()
    self.driver.find_element(By.CSS_SELECTOR, "input[id*='email']").send_keys("tmy131313@gmail.com")
    self.driver.find_element(By.CSS_SELECTOR, "input[id*='phone']").clear()
    self.driver.find_element(By.CSS_SELECTOR, "input[id*='phone']").send_keys(" ")
    self.driver.find_element(By.CSS_SELECTOR, "textarea[id*='notes']").send_keys("baongoc")
