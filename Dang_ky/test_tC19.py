...
class TestTC19:
    ...
    def test_tC19(self):
        ...
        driver.find_element(By.ID, "user_confirm_password").send_keys("Bay0613@")

        driver.find_element(By.CSS_SELECTOR, ".btn").click()

        # Verify lỗi Họ tên bắt buộc
        error = self.wait.until(EC.visibility_of_element_located((By.ID, "user_confirm_password-error")))
