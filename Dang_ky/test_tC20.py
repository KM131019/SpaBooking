...
class TestTC20:
    ...
    def test_tC20(self):
        ...
        self.wait.until(EC.visibility_of_element_located((By.ID, "user_login"))).send_keys("")
        driver.find_element(By.ID, "user_email").send_keys("")
        driver.find_element(By.ID, "user_pass").send_keys("")
        driver.find_element(By.ID, "user_confirm_password").send_keys("")
